...
class CnnOneAttNet(nn.Module):
    def __init__(self):
        ...
        self.lstm = nn.LSTM(embedding_dims, hidden_dims, batch_first=True, dropout=0.3, bidirectional=False)
        #self.lstm = nn.LSTM(embedding_dims+2*position_dims, hidden_dims, batch_first=True, dropout=0.3, bidirectional=False)
