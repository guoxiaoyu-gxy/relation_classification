...
def createMatrices(file, word2Idx, maxSentenceLen=100):
    ...
    for line in open(file):
        ...
        positionIndex = np.concatenate(positionIndex1, positionIndex2)
    ...
    return np.array(labels, dtype='int32'), np.array(tokenMatrix, dtype='int32'), np.array(positionMatrix1, dtype='int32'), np.array(positionMatrix2, dtype='int32'), np.array(positionIndex, dtype='int32')
