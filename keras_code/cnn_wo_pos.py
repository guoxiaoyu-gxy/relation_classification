...
for epoch in range(nb_epoch):       
    model.fit([sentenceTrain], yTrain, batch_size=batch_size, verbose=True, epochs=nb_epoch)
    pred_test = predict_classes(model.predict([sentenceTest], verbose=False))
