...
#emb_model = models.KeyedVectors.load_word2vec_format('../../word_embeddings/word2vec.glove.200d.txt')
#embeddings = emb_model.wv.get_keras_embedding(False)
